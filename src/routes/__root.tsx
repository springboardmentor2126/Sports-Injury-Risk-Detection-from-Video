  ...
  head: () => ({
    meta: [
      ...
      { title: "KinetIQ — AI Sports Injury & Performance Analysis" },
      {
        name: "description",
        content:
          "Upload a sports video. Get AI-powered pose analysis, injury risk detection, posture scoring, and personalized prevention exercises.",
      },
      { name: "author", content: "KinetIQ" },
      { property: "og:title", content: "KinetIQ — AI Sports Injury & Performance Analysis" },
      {
        property: "og:description",
        content: "AI video analysis for injury risk, technique, and performance.",
      },
