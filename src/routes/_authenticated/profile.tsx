    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="max-w-4xl mx-auto px-4 py-8">
        <div className="mb-6">
          ...
          <p className="text-sm text-muted-foreground mt-1">
            ...
            {roles.length > 0 && (
              <>
                {" "}
                · role: <span className="text-primary font-medium">{roles.join(", ")}</span>
              </>
            )}
          </p>
        </div>
        ...
        <form onSubmit={save} className="space-y-6">
          ...
          <Card>
            <CardHeader>
              <CardTitle>Sport &amp; training</CardTitle>
            </CardHeader>
            <CardContent className="grid gap-4 md:grid-cols-2">
              <Field label="Primary sport">
                <Input
                  value={p.primary_sport ?? ""}
                  placeholder="Sprinting, Cricket, Football…"
                  onChange={(e) => setP({ ...p, primary_sport: e.target.value })}
                />
              </Field>
              <Field label="Position / discipline">
                <Input
                  value={p.position ?? ""}
              ...
              <Field label="Training frequency">
                <Input
                  ...
                  placeholder="e.g. 5 sessions / week"
